...
public abstract class BaseObjectEntryResourceImpl
	...
	@jakarta.ws.rs.Path("{objectEntryId}/subscribe")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void postObjectEntrySubscribe(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("objectEntryId")
			Long objectEntryId)
	...
	@jakarta.ws.rs.Path("{objectEntryId}/unsubscribe")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void postObjectEntryUnsubscribe(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("objectEntryId")
			Long objectEntryId)
