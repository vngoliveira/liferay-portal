...
public class ObjectFieldLocalServiceTest {
	...
	public void testUpdateObjectField() throws Exception {
		_testUpdateObjectFieldWithEmptyDescriptionMap();
		_testUpdateObjectFieldWithNullDescriptionMap();
	...
	private void _testUpdateObjectFieldWithEmptyDescriptionMap()
		throws Exception {

		_testUpdateObjectFieldDescriptionMap(Collections.emptyMap());
	}

	private void _testUpdateObjectFieldWithNullDescriptionMap()
		throws Exception {
